...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark" aria-current="page">Customers</li>
          </ol>
    ...
    <!-- <div class="container">
      <div class="row">
        <div class="col-8">
          <a class="hrefence" href="../pages/addcustomer.html"><button type="button" class="btn btn-info"><i class="fa-solid fa-plus"></i> Add Customers</button></a> &nbsp;&nbsp;
          <button type="button" class="btn btn-success"><i class="fa-solid fa-upload"></i> Import</button>  &nbsp;&nbsp;
          <button type="button" class="btn btn-dark"><i class="fa-solid fa-download"></i> Export</button> &nbsp;&nbsp;
        </div>
        <div class="col-4">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
      ...
      <div class="container-fluid btnimp py-1 px-3">
        ...
        <a class="hrefence" href="../pages/addcustomer.php">

          <button type="button" class="btn btn-info btn-w btn-add">
            <i class="fa-solid fa-plus icn">
            </i> <span class="text">Add Customer</span></button></a> &nbsp;&nbsp;
            <a  class="hrefence" href="../pages/import.html"><button  type="button" class="btn btn-success btn-w">
              <i class="fa-solid fa-upload">
              </i>  <span>Import</span>
            </button>  </a>&nbsp;&nbsp;

        <button type="button" class="btn btn-dark btn-w">
          <i class="fa-solid fa-download">
          </i> <span onclick="tableToExcel()"> Export</span></button> &nbsp;&nbsp;
        <div class="ms-md-auto pe-md-3 d-flex align-items-center">
          <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <form method="post">
            <div class="input-group input-group-outline">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                        Remarks</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Manage
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php 
                      ...
                      if($result){
                       ...
                       $id = $row['id'];
                        ...
                        <td class="align-middle text-center text-sm">
                          <p class="text-xs font-weight-bold mb-0"><a class="text-xs font-weight-bold mb-0 viewref"
                              href="../pages/viewcustomer.php?custid='.$id.'">'.$name.'</a></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                        ...
                        <td class="align-middle text-center">
                          <button type="button" class="btn btn-info btn-sm btn-m1" data-bs-toggle="modal"
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="mb-3">
                                    <h6 class="text-xs font-weight-bold mb-0">Add Remarks</h6>
                                    <textarea id="address" class="form-control textareabox"  rows="5"
                                      style="width: 100%; height: 50%; border: 1px solid silver;"></textarea>
                                  </div>
                                </div>
                        ...
                        <td>
                          <div class="btn-holder">
                             <a class="reficon" href="editcustomers.php?editid='.$id.'"><button type="button"
                                class="btn btn-primary btn-sm btn-m2"><i
                                  class="fa-solid fa-pen-to-square"></i></button></a>
  
                            <a href="deletecustomer.php?deleteid='.$id.'"><button type="button" class="btn btn-danger btn-sm btn-m2"><i
