...
<link rel="stylesheet" type="text/css" href="  https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"/>
  ...
  <link rel="stylesheet" href="./css/staffrom.css">
  <style>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <!-- <li class="nav-item">
            <a class="nav-link text-white bgcolor active bg-gradient-primary " href="../pages/staff.html">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="material-icons opacity-10">table_view</i>
              </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark " aria-current="page">User</li>
          </ol>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0" href="../pages/login.html">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid btnimp py-1 px-3 ">
        ...
        <a class="hrefence" href="../pages/addstaff.php">   
          <button type="button" class="btn btn-info btn-w btn-add">
          <i class="fa-solid fa-plus icn">            
          </i> <span class="text">Add New User</span></button></a> 
                  ...
                  <tbody>
                    ...
                    if($result){
                      while($row =mysqli_fetch_assoc($result)){
                        ...
                        echo '
                        <tr class="table-hover" id="myTable">
                        ...
                        <td class="align-middle text-center text-sm">
                          <div class="btn-holder">
                            <a class="reficon" href="editstaff.php?editid='.$id.'"><button type="button" class="btn btn-primary btn-sm btn-m2"><i class="fa-solid fa-pen-to-square"></i></button></a>
  
                         <a href="deletestaff.php?deleteid='.$id.'"> <button type="button" class="btn btn-danger btn-sm btn-m2"><i class="fa-solid fa-trash"></i></button></a>
                          </div>
                        </td>
                      </tr>
                        ';
