    ...
    <div class="col-md-9">
       <div class="ibox float-e-margins">
        ...
        <div class="ibox-content" id="ibox_form" style="position: static; zoom: 1;">
            <div class="details" style="min-height: 200px; padding: 20px;">
            <div class="ibox-title">
                <h6 style="text-align: center;">View Customers</h6>
              </div>
              <?php 
              $id= $_GET['custid'];
              ...
              if($result){
               ...
               <strong>Full Name:</strong><label style="font-weight: bold;" >'.' '.$name.'</label>
               <strong>Company Name:</strong> <label style="font-weight: bold;" > '.' '.$company.'</label>
               <strong>Email:</strong><label style="font-weight: bold;" >'.' '.$email.'</label>
               <strong>Phone:</strong><label style="font-weight: bold;" >'.' '.$phone.'</label>
               <strong>Address:</strong><label style="font-weight: bold;" > '.' '.$address.'</label>
               <strong>City:</strong><label style="font-weight: bold;" >'.' '.$city.'</label>
               <strong>State/Region:</strong><label style="font-weight: bold;" > '.' '.$state.'</label>
               <strong>ZIP/Postal Code:</strong><label style="font-weight: bold;" >'.' '.$zipcode.'</label>
               <strong>Country:</strong><label style="font-weight: bold;" >'.' '.$country.'</label>
                </div>
               </p>';
