...
<body class="g-sidenav-show  bg-gray-200">
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white bg-primary bg-gradient-primary" href="../pages/tables.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark " aria-current="page">Quotes</li>
          </ol>
          <!-- <h6 class="font-weight-bolder mb-0">Quotes</h6> -->
        </nav>
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <a href="../pages/login.html" class="sign-in"> &nbsp;<span class="d-sm-inline d-none">Sign out</span></a>
              </a>
            </li>
    ...
    <!-- <div class="btnaddemp1">
      <a href="./Quotescreate.html"> 
        <button class="btn-info btn btn-info btn-w btn-add btnaddemp">
        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3  z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 flexbtnaddemp">
                <h6 class="text-white text-capitalize ps-3">Quotes</h6>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="paginated-list">
                  <thead>
                    <tr>
                      <th
                        class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center text-sm">
                        Id</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Date
                        Created</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Stage
                      </th>
...
if ($result) {
  ...
  <tr id="tabledelete">
    ...
    <td class=" text-center text-sm">
     ...
     <a href="deleteQuotes.php?deleteQuotesid='.$id.'"> <button type="button" class="btn btn-danger btn-sm"> 
